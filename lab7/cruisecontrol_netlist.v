...
// Date      : Sun Oct 17 16:08:14 2021
/////////////////////////////////////////////////////////////


module cruisecontrol_DW01_inc_2 ( A, SUM );
  input [7:0] A;
  output [7:0] SUM;
...
module cruisecontrol_DW01_inc_3 ( A, SUM );
  input [7:0] A;
  output [7:0] SUM;
...
module cruisecontrol ( clk, reset, throttle, set, accel, coast, cancel, resume, 
  ...
  cruisecontrol_DW01_inc_2 add_118 ( .A({cruisespeed[7], n305, n306, 
        cruisespeed[4], n308, cruisespeed[2], n310, n311}), .SUM({N145, N144, 
        N143, N142, N141, N140, N139, N138}) );
  cruisecontrol_DW01_inc_3 r127 ( .A({speed[7], n298, speed[5:0]}), .SUM({n2, 
